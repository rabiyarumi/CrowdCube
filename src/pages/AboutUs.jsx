...
const AboutUs = () => {
  return (
    <div className="flex flex-col md:flex-row-reverse gap-6 md:gap-8 w-[85%] mx-auto my-10 md:my-20">
      <div className="bg-primary bg-opacity-35 rounded-t-full rounded-bl-full w-1/2">
        <img src={aboutImg} alt="" />
      </div>
      <div className="w-1/2 flex flex-col gap-6 justify-center">
      <h2 className="text-4xl font-bold  ">
            About <span className="text-primary ">Crowdcube</span>
          </h2>
        <p>
        ...
        <Link to={`/#contact-us`} className="btn btn-outline btn-primary w-fit">Contact Us</Link>
      </div>
    </div>
  );
};
